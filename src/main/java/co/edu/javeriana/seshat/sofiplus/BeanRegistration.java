...
//                        Class<? extends ModuleRunnable> methodClass = (Class<? extends ModuleRunnable>) urlcl.loadClass("co.edu.javeriana.seshat.sofiplus.Modules.src." + module.getName() + ".Methods." + method.getName());
