...
public class ReciboCaja {
    ...
    public ReciboCaja(String id, String fecha, double suma, String sumaLetras, String descripcion, String clienteID, String facturaID, double debito, double credito) {
        this.id = id;
        this.fecha = fecha;
        this.suma = suma;
